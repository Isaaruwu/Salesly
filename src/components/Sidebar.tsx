...
export const Sidebar = () => {
  ...
  return (
    <aside className="flex w-56 flex-col select-none pt-2">
      ...
      >
        <div className="flex size-15 lg:size-7 items-center justify-center rounded-lg">
          <Brain color="#b1b9f9" className="size-8 lg:size-7 text-primary-foreground transition-all duration-300" />
        </div>
