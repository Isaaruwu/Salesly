...
import type { PendingKYCUpdate, ComplianceFlag, SalesPrompt } from "@/pages/app/components/completion/KYCDiffPanel";
// import {
//   AttachedFile,
//   ChatMessage,
//   ChatConversation,
...
export interface UseCompletionReturn {
  ...
  // KYC Diff state
  /** Pending KYC updates extracted from structured AI responses */
  pendingKYCUpdates: PendingKYCUpdate[];
  /** Compliance flags extracted from structured AI responses */
  pendingComplianceFlags: ComplianceFlag[];
  /** Clear all pending KYC updates and compliance flags */
  clearPendingKYC: () => void;
  /** Pending sales opportunities extracted from structured AI responses */
  pendingSalesPrompts: SalesPrompt[];
  /** Clear all pending sales prompts */
  clearPendingSalesPrompts: () => void;
  /** Whether a background meeting transcript is currently being analysed */
  isMeetingAnalysing: boolean;
