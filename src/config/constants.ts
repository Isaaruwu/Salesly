...
// Default provider selections (keys loaded from .env via Vite)
...
export const DEFAULT_STT_PROVIDER = {
  provider: "google-stt",
  variables: {
    api_key: import.meta.env.VITE_GOOGLE_STT_API_KEY ?? "",
    project_id: import.meta.env.VITE_GOOGLE_STT_PROJECT_ID ?? "",
  },
};
