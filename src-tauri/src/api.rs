...
pub async fn transcribe_audio(
    ...
    let api_config = fetch_api_response_config(&app, None, None).await?;
    ...
    let error_provider: Option<String> = None;
    let error_model: Option<String> = None;
...
pub async fn create_system_prompt(
    ...
    // Make HTTP request to prompt endpoint
    let client = reqwest::Client::new();
